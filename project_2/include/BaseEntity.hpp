...
namespace Entities
{
    ...
    public:
        ...
        //typedef cpp::result<bool, std::string> (*MATCH_FUNC_STATIC)(std::unique_ptr<BaseEntity> &target, std::unique_ptr<BaseEntity> &source, std::vector<std::string> &fields, int &index) noexcept;
        uuids::uuid id;
        virtual ~BaseEntity();
