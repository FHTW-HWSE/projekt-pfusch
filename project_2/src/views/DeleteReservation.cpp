...
namespace UiMenu
{
    void DeleteReservation::show()
    {
        ...
        auto r_selection = Fascades::UiFascade::print_options_and_get_result(options, "please select a reservation to delete");
        ...
        auto r_update = Fascades::DbFascade::delete_reservation(*reservation);
        ...
        Fascades::UiFascade::print_string("reservation deleted.");
